...
import {
  ...
  import ReadFloor from "./read";
  import UpdateFloor from "./update";

  export default function FloorSmallCard(props: {
    item: FloorItem;
    onClick?: () => void;
  }) {
    ...
    return (
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            {isViewing && (item.id>0) && <ReadFloor id={item.id} />}
          </SheetDescription>
        </SheetHeader>
      </SheetContent>
    </Sheet>
    ...
    <SheetContent>
      <SheetHeader>
        <SheetTitle>{item.name}</SheetTitle>
        <SheetDescription>
          {isEditing && (item.id>0) && <UpdateFloor id={item.id} />}
        </SheetDescription>
      </SheetHeader>
    </SheetContent>
  </Sheet>
