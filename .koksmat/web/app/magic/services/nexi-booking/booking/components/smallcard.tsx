...
import {
  ...
  import ReadBooking from "./read";
  import UpdateBooking from "./update";

  export default function BookingSmallCard(props: {
    item: BookingItem;
    onClick?: () => void;
  }) {
    ...
    return (
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            {isViewing && (item.id>0) && <ReadBooking id={item.id} />}
          </SheetDescription>
        </SheetHeader>
      </SheetContent>
    </Sheet>
    ...
    <SheetContent>
      <SheetHeader>
        <SheetTitle>{item.name}</SheetTitle>
        <SheetDescription>
          {isEditing && (item.id>0) && <UpdateBooking id={item.id} />}
        </SheetDescription>
      </SheetHeader>
    </SheetContent>
  </Sheet>
