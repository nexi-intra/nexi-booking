...
import {
  ...
  import ReadBuilding from "./read";
  import UpdateBuilding from "./update";

  export default function BuildingSmallCard(props: {
    item: BuildingItem;
    onClick?: () => void;
  }) {
    ...
    return (
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>
            {isViewing && (item.id>0) && <ReadBuilding id={item.id} />}
          </SheetDescription>
        </SheetHeader>
      </SheetContent>
    </Sheet>
    ...
    <SheetContent>
      <SheetHeader>
        <SheetTitle>{item.name}</SheetTitle>
        <SheetDescription>
          {isEditing && (item.id>0) && <UpdateBuilding id={item.id} />}
        </SheetDescription>
      </SheetHeader>
    </SheetContent>
  </Sheet>
